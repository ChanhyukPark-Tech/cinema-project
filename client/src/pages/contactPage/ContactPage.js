            ...
            <ContactPageStyled>
                <div className={'contact-section'}>
                    ...
                    <div className="right-content">
                        <ContactItem title={'Phone'} icon={phoneIcon} cont1={'+82-1400****'} cont2={'031-400-****'}/>
                        <ContactItem title={'Email'} icon={emailIcon} cont1={'CEOCinema@ceo.com'}
                                     cont2={'CEOCinema2@ceo.com'}/>
                        <ContactItem title={'Address'} icon={locationIcon} cont1={'Ansan'}
